...
class _WeatherAppState extends State<WeatherApp> {
  String apiKey = '44f83194f32b63da7b04a0fe956d0208';
  var city;
  var position;
  var description;
  var temp;
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    child: Text(city == null ? 'Fetching location...' : city, style:
                      TextStyle(
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold,
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text('Temperature: ${temp == null ? '...' : '$temp °C'}'),
                subtitle: Text('Status: ${description == null ? '...' : description}'),
              ),
            ),
            Container(
              child: Center(
